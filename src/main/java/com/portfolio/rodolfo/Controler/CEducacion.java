...
public class CEducacion {
    ...
    public ResponseEntity<?> create(@RequestBody dtoEducacion dtoeducacion){
        ...
        Educacion educacion = new Educacion(
                dtoeducacion.getNombreEdu(), dtoeducacion.getDescripcionEdu(), dtoeducacion.getInstitucion() , dtoeducacion.getAgnoInicio() , dtoeducacion.getAgnoFinal()
            );
    ...
    public ResponseEntity<?> update(@PathVariable("id") int id, @RequestBody dtoEducacion dtoeducacion){
        ...
        if(sEducacion.existsByNombreEdu(dtoeducacion.getNombreEdu()) && sEducacion.getByNmbreEdu(dtoeducacion.getNombreEdu()).get().getId() != id){
            return new ResponseEntity(new Mensaje("Ese nombre ya existe"), HttpStatus.BAD_REQUEST);
        }
        if(StringUtils.isBlank(dtoeducacion.getNombreEdu())){
        ...
        educacion.setAgnoInicio(dtoeducacion.getAgnoInicio());
        educacion.setAgnoFinal(dtoeducacion.getAgnoFinal());
